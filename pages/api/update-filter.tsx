...
import { API_FILTER_JSON, API_PREVIOUS_FILTER_JSON, API_USER_CODE } from "../../constants";
import { getDBClient, getUserIDFromCode, tryAddFilter, subscribeUserToFilter, getMatchingFilterID, unsubscribeUserFromFilter } from '../../lib/database_utils';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (!(req.query[API_USER_CODE] && typeof req.query[API_USER_CODE] === 'string'
      ...
      && req.query[API_PREVIOUS_FILTER_JSON] && typeof req.query[API_PREVIOUS_FILTER_JSON] === 'string')) {
