...
export default function Login({usercode, setUserCode}: DefaultPageProps) {
  ...
  <div>
    ...
    >
      <p>
        It looks like the link you used is from a <b>different user account.</b> Do you want to use your existing user code, or log in with the new one?
      </p>
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.codeContainer}>
          <div style={{height: "fit-content"}}>
            ...
            <p style={{marginTop: "0"}} className={styles.usercodeText}>{newUserCode}</p>
          </div>
          <div className={styles.buttonDiv}>
            <LoadingButton
              onClick={() => {
